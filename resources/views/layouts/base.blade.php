    ...
    <div class="container">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavFluxo">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link" href="{{ route('lancamento.index', ['id'=>1]) }}">
        ...
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
            <div class="col-md-12 d-flex align-items-center">
                ...
                &nbsp;
                <a href="www.linkedin.com/in/athylagjpires" class="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1">
                 - Athyla Guilherme
                </a>
            </div>
        </footer>
